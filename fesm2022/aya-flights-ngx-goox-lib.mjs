...
class Campaign extends BaseEntityEx {
    get(field) {
        if (!this.props) {
            return "";
        }
...
class Credit extends BaseEntityEx {
    get(field) {
        if (!this.props) {
            return "";
        }
...
class Lead extends BaseEntityEx {
    get(field) {
        if (!this.props) {
            return "";
        }
...
class Lookup extends BaseEntityEx {
    get(field) {
        if (!this.props) {
            return "";
        }
...
class Account extends BaseEntityEx {
    get(field) {
        if (!this.props) {
            return "";
        }
...
class Booking extends BaseEntityEx {
    get(field) {
        if (!this.props) {
            return "";
        }
...
class Maintenance extends BaseEntityEx {
    get(field) {
        if (!this.props) {
            return "";
        }
...
class AuditLog extends BaseEntityEx {
    get(field) {
        if (!this.props) {
            return "";
        }
...
class Certificate extends BaseEntityEx {
    get(field) {
        if (!this.props) {
            return "";
        }
...
class Contact extends BaseEntityEx {
    get(field) {
        if (!this.props) {
            return "";
        }
...
class Airplane extends BaseEntityEx {
    get(field) {
        if (!this.props) {
            return "";
        }
...
class SystemMessage extends BaseEntityEx {
    get(field) {
        if (!this.props) {
            return "";
        }
...
class MessageConfirm extends BaseEntityEx {
    get(field) {
        if (!this.props) {
            return "";
        }
...
class Flight extends BaseEntityEx {
    get(field) {
        if (!this.props) {
            return "";
        }
...
class LookupGroup extends BaseEntity {
}
function GetLookupGroupColumnsDef() {
    let result = [];
    result.push(new ColumnDef("id", "string", ""));
    result.push(new ColumnDef("createdOn", "number", "datetime"));
    result.push(new ColumnDef("updatedOn", "number", "datetime"));
...
class Document extends BaseEntityEx {
    get(field) {
        if (!this.props) {
            return "";
        }
...
class FlightTicket extends BaseEntityEx {
    get(field) {
        if (!this.props) {
            return "";
        }
...
class SystemConfig extends BaseEntityEx {
    get(field) {
        if (!this.props) {
            return "";
        }
...
class User extends BaseEntityEx {
    get(field) {
        if (!this.props) {
            return "";
        }
...
class LookupsEndPoint {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "18.1.5", ngImport: i0, type: LookupsEndPoint, deps: [{ token: 'config' }, { token: RestUtil }], target: i0.ɵɵFactoryTarget.Injectable }); }
...
class SystemConfigsEndPoint {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "18.1.5", ngImport: i0, type: SystemConfigsEndPoint, deps: [{ token: 'config' }, { token: RestUtil }], target: i0.ɵɵFactoryTarget.Injectable }); }
...
class SystemEndPoint {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "18.1.5", ngImport: i0, type: SystemEndPoint, deps: [{ token: 'config' }, { token: RestUtil }], target: i0.ɵɵFactoryTarget.Injectable }); }
