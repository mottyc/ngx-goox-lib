...
function GetCreditColumnsDef() {
    ...
    result.push(new ColumnDef("amount", "number"));
...
function GetLeadColumnsDef() {
    ...
    result.push(new ColumnDef("price", "number"));
    result.push(new ColumnDef("commission", "number"));
    result.push(new ColumnDef("totalCost", "number"));
...
function GetCertificateColumnsDef() {
    ...
    result.push(new ColumnDef("validUntil", "number"));
    result.push(new ColumnDef("status", "StatusCode"));
    result.push(new ColumnDef("notifyAt", "number"));
...
function GetAccountColumnsDef() {
    ...
    result.push(new ColumnDef("currentCredit", "number"));
    result.push(new ColumnDef("baseRate", "number"));
...
function GetBookingColumnsDef() {
    ...
    result.push(new ColumnDef("placementOn", "number"));
    result.push(new ColumnDef("placementTo", "number"));
    return result;
}
...
function GetCampaignColumnsDef() {
    ...
    result.push(new ColumnDef("startDate", "number"));
    result.push(new ColumnDef("endDate", "number"));
    result.push(new ColumnDef("budget", "number"));
    result.push(new ColumnDef("baseRate", "number"));
    result.push(new ColumnDef("referUrl", "string"));
    result.push(new ColumnDef("expectedCost", "number"));
    result.push(new ColumnDef("actualCost", "number"));
    result.push(new ColumnDef("currency", "CurrencyCode"));
    return result;
}
...
function GetDocumentColumnsDef() {
    ...
    result.push(new ColumnDef("activeFrom", "number"));
    result.push(new ColumnDef("activeUntil", "number"));
...
function GetMaintenanceColumnsDef() {
    ...
    result.push(new ColumnDef("documentId", "string"));
    result.push(new ColumnDef("hobs", "number"));
    result.push(new ColumnDef("nextHobs", "number"));
    result.push(new ColumnDef("tach", "number"));
    result.push(new ColumnDef("nextTach", "number"));
    result.push(new ColumnDef("validUntil", "number"));
    result.push(new ColumnDef("status", "StatusCode"));
...
function GetMessageConfirmColumnsDef() {
    ...
    result.push(new ColumnDef("replyOn", "number"));
