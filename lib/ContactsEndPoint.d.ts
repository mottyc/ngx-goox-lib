/// <reference path="ContactsEndPoint.ngtypecheck.d.ts" />
...
export declare class ContactsEndPoint {
     ...
     */
    find(search?: string, sort?: string, page?: number, size?: number): import("rxjs").Observable<EntitiesResponse<Contact>>;
